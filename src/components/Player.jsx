...
export const ExcersizeCard = ({src, name, description, link}) => {
  ...
  <div className="max-w-xs overflow-hidden relative text-white rounded-lg group">
    ...
    <Link to={link} className='hidden hover:scale-105 hover:underline absolute bottom-0 right-0 w-fit justify-end group-hover:flex gap-0.5 cursor-pointer'>
      Fitnotes
